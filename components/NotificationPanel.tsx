    ...
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="w-[400px] sm:w-[500px] p-0 border-l border-border bg-[#F8F9F9]">
        <div className="flex flex-col h-full">
          <SheetHeader className="px-6 py-8 border-b border-border bg-white">
            <div className="flex items-center justify-between">
              <SheetTitle className="text-sm font-bold uppercase tracking-widest text-[#4A4A2C] flex items-center gap-2">
            ...
            {notifications.length === 0 ? (
              ...
              <div className="space-y-4 pt-2">
                {notifications.map((notif, idx) => (
                  <div key={idx} className="p-4 bg-white border border-border rounded-xl shadow-sm hover:border-primary/20 transition-all group">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-sm text-[#4A4A2C] font-semibold tracking-tight">{notif.message}</p>
                        <p className="text-[11px] text-[#616164] leading-relaxed opacity-80 pt-1">
